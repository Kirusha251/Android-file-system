...
/**
 * Created by Kirill on 31.10.2016.
 */

public class MyDataBaseQueryHelper{
    ...
    public static void insertStudentQuery(int idGroup, int idStudent, String name){
        ...
        try {
            ...
            context.getContentResolver().insert(Uri.parse("content://com.example.kirill.studentsprovider/studentList/"+idGroup),values);
    ...
    public static void updateStudentQuery(int idGroup, int idStudent, String name){
        try {
            ...
            values.put("IDSTUDENT", idStudent);
            values.put("NAME", name);
            context.getContentResolver().update(Uri.parse("content://com.example.kirill.studentsprovider/studentList/"+idGroup+"/"+idStudent),values,null,null);
    ...
    public static void insertGroupQuery(int idGroup,String faculty,int course,String name, String head){
        ...
        Uri uri = context.getContentResolver().insert(Uri.parse("content://com.example.kirill.studentsprovider/groupList/"),values);
    ...
    public static void updateGroupQuery(String editID,int idGroup){
        ...
        //dataBase.update("STUDGROUPS",values,"IDGROUP=?",new String[]{editID});
            context.getContentResolver().update(Uri.parse("content://com.example.kirill.studentsprovider/groupList/"+editID),values,null,null);
        }catch (SQLiteException ex){
            Toast.makeText(context,"cant updated",Toast.LENGTH_SHORT).show();
    ...
    public static void deleteStudentQuery(int idStudent, int idGroup){
        try {
            int i = context.getContentResolver().delete(Uri.parse("content://com.example.kirill.studentsprovider/studentList/"+idGroup+"/"+idStudent),null,null);
        }
        catch (SQLiteException ex){
    ...
    public static void deleteGroupQuery(int idGroup){
        try {
            if(idGroup!=-1) {
                int i = context.getContentResolver().delete(Uri.parse("content://com.example.kirill.studentsprovider/groupList/" + idGroup), null, null);
            }
            else{
                int i = context.getContentResolver().delete(Uri.parse("content://com.example.kirill.studentsprovider/groupList"), null, null);
            }
        }
        catch (SQLiteException ex){
            Toast.makeText(context,"Can't delete",Toast.LENGTH_SHORT).show();
    ...
    public static ArrayList<String> getStudentList(ContentResolver resolver){
        ...
        Cursor cursor = resolver.query(Uri.parse("content://com.example.kirill.studentsprovider/studentList"),new String[]{"IDGROUP","NAME","IDSTUDENT"},null,null,null);
    ...
    public static ArrayList<String> getGroupList(){
        ...
        Cursor cursor = context.getContentResolver().query(Uri.parse("content://com.example.kirill.studentsprovider/groupList"),null,null,null,null);
        if(cursor.moveToFirst()){
    ...
    public static ArrayList<String> getStudentsListByGroupId(int idGroup){
        ArrayList<String> listGroup= new ArrayList<>();
        Cursor cursor = context.getContentResolver().query(Uri.parse("content://com.example.kirill.studentsprovider/" +
