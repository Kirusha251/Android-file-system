...
public class StudentActivity extends AppCompatActivity {
    ...
    public void onAddButtonClick(View view){
        if(idStudent.getText().toString().equals("")){
            QueryHelper.insertStudentQuery(Integer.valueOf(idGroup.getText().toString()),
    ...
    public void onUpdateButtonClick(View view){
        QueryHelper.updateStudentQuery(Integer.valueOf(idGroup.getText().toString()),
                Integer.valueOf(idStudent.getText().toString()),name.getText().toString());
    ...
    public void onGetButtonClick(View view){
        studentListAdapter = new ArrayAdapter<String>(getBaseContext(),android.R.layout.simple_list_item_1,
                QueryHelper.getStudentsListByGroupId(Integer.valueOf(idGroup.getText().toString())));
        viewStudents.setAdapter(studentListAdapter);
    }

    public void onDeleteButtonClick(View view){
        QueryHelper.deleteStudentQuery(Integer.valueOf(idStudent.getText().toString()),
